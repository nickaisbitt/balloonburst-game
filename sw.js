...
const VERSION = "2.3.0+1cd58908";
const CACHE = `balloon-burst-v${VERSION}`;

const APP_SHELL = ["./","./index.html","./manifest.webmanifest","./privacy.html","./icon-180.png","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./assets/fredoka-var-DOQG_Jwn.woff2","./assets/index-0YijZqDd.js","./assets/index-BuaIIZPD.js","./assets/index-DxwF5K0h.css","./assets/nunito-var-CjueodBP.woff2","./assets/web-rq7A5PWq.js"];
