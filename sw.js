...
const VERSION = "2.2.2+df67a66e";
const CACHE = `balloon-burst-v${VERSION}`;

const APP_SHELL = ["./","./index.html","./manifest.webmanifest","./privacy.html","./icon-180.png","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./assets/fredoka-var-DOQG_Jwn.woff2","./assets/index-B15GinxL.css","./assets/index-DhXg-nAX.js","./assets/index-Dwc4qIZL.js","./assets/nunito-var-CjueodBP.woff2","./assets/web-DSAUv_XU.js"];
